        ...
        <div>
            ...
            <textarea name="description"
                      ...
                      class="w-full mt-1 px-4 py-2 rounded-lg
                             ...
                             focus:outline-none focus:ring-2 focus:ring-primary">{{ old('description', $type->description) }}</textarea>
        </div>
        ...
        <div>
            ...
            <select name="is_active"
                    class="w-full mt-1 px-4 py-2 rounded-lg
                           bg-bg border border-border
                           focus:outline-none focus:ring-2 focus:ring-primary">
                           <option value="0" {{ old('is_active', $type->is_active) == 0 ? 'selected' : '' }}>
                               Inactive
                           </option>
                <option value="1" {{ old('is_active', $type->is_active) == 1 ? 'selected' : '' }}>
                    Active
                </option>
            </select>
        </div>
